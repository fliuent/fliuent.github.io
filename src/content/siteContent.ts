...
export const initialHobbies: Hobby[] = [
  ...
  },
  {
    ...
    title: "Gourmet",
    category: "Enjoyment",
    description: "An unapologetic foodie on a mission. Whether I'm hunting down the perfect spicy Thai curry, savoring authentic Chinese classics, or discovering global flavors, I'll be dropping my personal reviews and tasting notes right here. The kitchen is currently prepping this feature, so bring your appetite soon!",
  ...
  },
  {
    ...
    title: "Hiking",
    category: "Recreation",
    description: "Trading the desk for elevation. I'm hitting the trails to rate and review Hong Kong's most scenic (and sweat-inducing) routes, sharing everything from difficulty levels to the best viewpoints. I'm still mapping out the logistics for this section, but get your boots ready—trail guides are on the horizon.",
  ...
  },
  {
    ...
    title: "Travel",
    category: "Relaxing",
    description: "My passport is getting a workout, and eventually, this page will too. From bustling cityscapes to quiet getaways, I am organizing my travelogues, itineraries, and tips to share with you. This section is currently experiencing a brief layover, but the full itinerary is arriving shortly!",
