                ...
                {selectedHobby.iconName === "Sliders" && (
                  <div className="pt-4 border-t border-gray-100">
                    ...
                    >
                      ...
                      <span>{activeSimulation ? "Active Simulator Running" : "Launch Billiards sandbox"}</span>
                    </button>
                  </div>
                )}
              </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 md:p-6 text-slate-100 flex flex-col space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-white font-heading">
                      Billiard Trajectory & Collision Simulator
                    </h3>
                    <p className="text-[10px] text-slate-400 font-mono">
                      Dynamic math modeling of billiard-ball reflection vectors
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <div className="flex items-center gap-1.5 bg-slate-950 px-2.5 py-1 rounded-lg border border-slate-800">
                    ...
                    <span className="text-[10px] text-slate-400 font-mono">Elasticity: {gravityStr.toFixed(1)}</span>
                    <input
                      type="range"
                      min="0.1"
                      max="1.5"
                  ...
                  <div className="flex items-center gap-1.5 bg-slate-950 px-2.5 py-1 rounded-lg border border-slate-800">
                    ...
                    <span className="text-[10px] text-slate-400 font-mono">Ball Count: {particleCount}</span>
                    <input
                      type="range"
                      min="10"
                      max="120"
              ...
              >
                ...
                <div className="absolute bottom-3 left-3 bg-slate-900/85 backdrop-blur-xs px-2.5 py-1 rounded border border-slate-800 pointer-events-none">
                  <span className="text-[9px] text-[#007bfe] font-mono block">Physics Demonstration</span>
                  <span className="text-[10px] text-slate-400 block font-sans">
                    Hover to guide ball coordinates and watch kinetic energy scatter
                  </span>
                </div>
              </div>
            </div>
